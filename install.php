...
|     $Revision: 11912 $
|     $Id: install_.php 11912 2010-10-23 16:40:35Z e107steved $
|     $Author: e107steved $
+----------------------------------------------------------------------------+
*/
...
?".">";
		...
		if ($config_result) 
		{
			...
			$this->logLine('Error writing e107_config: '.$config_result);
		} 
		else 
		{
			$this->logLine('e107_config written successfully');
...
//		mysql_query("INSERT INTO {$this->previous_steps['mysql']['prefix']}plugin VALUES (0, '".LANINS_095."', '0.03', 'Integrity Check', 1, '') ");
		...
		if (mysql_close($link))				// Need to specify $link due to bug in PHP5.3 : http://bugs.php.net/bug.php?id=48754&edit=1
		{
