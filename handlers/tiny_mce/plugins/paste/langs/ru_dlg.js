...
text_title:"Используйте Ctrl+V на клавиатуре, чтобы вставить текст в окно.",
text_linebreaks:"Сохраняйте разрывы строки",
word_title:"Используйте Ctrl+V на клавиатуре, чтобы вставить текст в окно."
});