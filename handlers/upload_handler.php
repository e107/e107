...
// Predator 05.09.2012 Функция перевода имен загружаемых файлов из кириллицы в транслит
function transliteration_file_name($symbol_match) {
	$symbol_replace = array(
		'А' => 'A',		'Б' => 'B',		'В' => 'V',		'Г' => 'G',		'Д' => 'D',
		'Е' => 'E',		'Ё' => 'E',		'Ж' => 'J',		'З' => 'Z',		'И' => 'I',
		'Й' => 'Y',		'К' => 'K',		'Л' => 'L',		'М' => 'M',		'Н' => 'N',
		'О' => 'O',		'П' => 'P',		'Р' => 'R',		'С' => 'S',		'Т' => 'T',
    ...
    return strtr($symbol_match, $symbol_replace);
...
// That's the basics set up - we can start processing files now
	...
	// Predator 05.09.2012 Перевод имен загружаемых файлов из кириллицы в транслит и в нижний регистр
	$name = mb_strtolower($name, 'UTF-8');
	$name = transliteration_file_name($name);
