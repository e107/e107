...
define("LDAPLAN_3", "Пользователь LDAP<br />Полный контекст пользователя, имеющего права на поиск в директории");
...
define("LDAPLAN_8", "Будет использоваться, чтобы убедиться, что имя пользователя находится в правильном дереве<br />т. е. '(objectclass=inetOrgPerson)'");
define("LDAPLAN_9", "Текущий фильтр поиска:");
