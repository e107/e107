...
define("LANHELP_4", "Циан");
define("LANHELP_5", "Синий");
define("LANHELP_6", "Бордовый");
...
define("LANHELP_23", "Вставить ссылку: [link]http://example.ru[/link] или  [link=http://example.ru]Перейти к сайту[/link]");
define("LANHELP_24", "Жирный текст: [b]Этот текст будет жирным[/b]", "font-weight:bold; width: 20px");
define("LANHELP_25", "Наклонный текст: [i]Этот текст будет наклонным[/i]", "font-style:italic; width: 20px");
define("LANHELP_26", "Подчёркнутый текст: [u]Это текст будет подчёркнутым[/u]", "text-decoration: underline; width: 20px");
define("LANHELP_27", "Вставить изображение: [img]image.jpg[/img]");
define("LANHELP_28", "Разместить по центру: [center]Этот текст будет размещён по центру[/center]");
define("LANHELP_29", "Разместить слева: [left]Этот текст будет размещён слева[/left]");
define("LANHELP_30", "Разместить справа: [right]Этот текст будет размещён справа[/right]");
...
define("LANHELP_44", "Щелкните, чтобы открыть/закрыть диалог смайликов ...");
define("LANHELP_45", "Вставить изображении из каталога:");
define("LANHELP_46", "* Не найдено файлов в:");
define("LANHELP_47", "Вставить flash: [flash=width,height]http://www.example.ru/file.swf[/flash]");
define("LANHELP_48", "YouTube видео: [youtube=tiny|small|medium|big|huge|width,height]6kYjxJmk0wc[/youtube]");
define("LANHELP_49", "Выровнять по ширине: [justify]Этот текст будет выровнен по ширине[/justify]");
