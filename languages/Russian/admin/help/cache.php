...
$caption = "Кэширование";
$text = "Если вы включите кэширование, это значительно увеличит скорость вашего сайта и минимизирует количество вызовов к базе данных SQL.<br /><br /><b>ВАЖНО! Если вы создаете собственную тему - выключите кэширование, так как в противном случае изменения, которые вы сделаете, не будут отображаться.</b>";
