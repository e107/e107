...
$text = "Эта страница позволит вам установить сообщение, которое будет появляться вверху главной страницы сайта. Можно установить разные сообщения для гостей, зарегистрированных/вошедших пользователей и Администраторов.";
