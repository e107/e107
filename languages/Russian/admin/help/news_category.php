...
$text = "Вы можете разделить новости между различными категориями и позволить посетителям смотреть новости только выбранных категорий. <br /><br />Значки для новостей можно загрузить на сервер как в</br>".e_THEME."-yourtheme-/images/ или в themes/shared/newsicons/.";
