...
$text = "Установка нового языка даст вам возможность иметь версию контента вашего сайта на выбранном языке.

Так же тут Вы можете редактировать языковые файлы и создавать языковые пакеты.";
