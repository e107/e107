...
$text = "Используйте эту страницу для редактирования свойств или удаления Администраторов сайта. Администратору будет разрешено обращаться только к тем возможностям системы, которые отмечены флажком.<br /><br />
