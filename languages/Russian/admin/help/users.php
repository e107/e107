...
$text = "Эта страница позволяет создавать зарегистрированных пользователей. Среди прочего, здесь вы можете обновлять их свойства, давать им права администратора и устанавливать для них классы.";
