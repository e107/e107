...
define("LANINS_106", "ВНИМАНИЕ - E107 не может произвести запись в перечисленные директории и/или файлы. Если установка E107 все же не прервалась, то это значит, что некоторые возможности будут недоступны.  Вы должны изменить права доступа к файлу для использования этих возможностей");
