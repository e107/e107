...
define("LOGIN_MENU_L10", "Сайт закрыт на техническое обслуживание. Все пользователи будут перенаправлены на страницу sitedown.php. Для активации сайта перейдите в Админцентр/Техническое обслуживание");
